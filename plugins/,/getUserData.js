...
if(((Date.now()-user.times[user.times.length-1][0])>0)&&user.isLogin==='online'){var ol=`online for ${formatHMS((Date.now()-user.times[user.times.length-1][0]))}`}else{var ol=`offline`;}
